...
final class OnboardingViewController: UIPageViewController {
    ...
    override func viewDidLoad() {
        ...
        let page1 = setupOnboardingPage(imageName: "Onboarding_page1", labelText: "Отслеживайте только то, что хотите")
        let page2 = setupOnboardingPage(imageName: "Onboarding_page2", labelText: "Даже если это\nне литры воды или йога")
    ...
    func setupOnboardingPage(imageName: String, labelText: String) -> UIViewController {
