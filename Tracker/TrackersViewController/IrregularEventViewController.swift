...
final class IrregularEventViewController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        NSLayoutConstraint.activate([
            ...
            eventPageHeader.topAnchor.constraint(equalTo: view.topAnchor, constant: 26),
            eventPageHeader.centerXAnchor.constraint(equalTo: view.centerXAnchor),
    ...
    private func addSubviews() {
        view.addSubview(eventPageHeader)
    ...
    @objc private func createButtonTapped() {
        ...
        let newEvent = Tracker(name: text, color: colors[Int.random(in: 0..<self.colors.count)], emoji: "❤️", schedule: TrackerSchedule.DaysOfTheWeek.allCases)
